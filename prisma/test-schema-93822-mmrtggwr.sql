...
-- CreateIndex
CREATE UNIQUE INDEX "AppPrincipalSession_legacySessionId_key" ON "AppPrincipalSession"("legacySessionId");

-- CreateIndex
CREATE INDEX "AppPrincipalSession_legacySessionId_idx" ON "AppPrincipalSession"("legacySessionId");
