...
- `README.md` describes install flow and pack overview.
- `PLUGIN_SPEC.md` is the current implementation contract.
- `EVENT_HOOKUPS.md` is the current editor integration guide.
